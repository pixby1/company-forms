...
/* harmony import */ var styled_jsx_style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(styled_jsx_style__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var superagent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
...
function (_React$Component) {
  ...
  _createClass(_default, null, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
        var req, db, _list, hostname, _ref2, list;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                _context.next = 11;
                return superagent__WEBPACK_IMPORTED_MODULE_3__["get"](hostname + "/api").then(function (res) {
                  return res.body;
                });
  ...
  _createClass(_default, [{
    ...
    value: function remove(_id) {
      ...
      return function (ev) {
        var hostName = _this3.getHostName();

        console.log(hostName);
        superagent__WEBPACK_IMPORTED_MODULE_3__["del"]("".concat(hostName, "/api/").concat(_id)).then(function () {
    ...
    value: function add() {
      ...
      return function (ev) {
        ...
        var hostName = _this4.getHostName();

        superagent__WEBPACK_IMPORTED_MODULE_3__["post"](hostName + "/api", formData).then(function (res) {
          var state = _this4.state || {};
